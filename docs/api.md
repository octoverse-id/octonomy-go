...
- [`openapi-v2.yaml`](openapi-v2.yaml) — `/api/v2`, server **3.2.1**. The default surface.
- [`openapi.yaml`](openapi.yaml) — `/api/v1`, server **3.2.1**. Both specs now track the same server
  release.
